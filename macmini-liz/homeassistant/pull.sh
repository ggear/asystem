...
mkdir -p src/main/resources/config/www/custom_ui/bom-weather-card/icons/bom_icons &&
  unzip ../../../asystem_external/homeassistant/bom-weather-card/bom_icons.zip -d src/main/resources/config/www/custom_ui/bom-weather-card/icons/bom_icons
mkdir -p src/main/resources/config/www/custom_ui/bom-weather-card/icons/weather_icons &&
  unzip ../../../asystem_external/homeassistant/bom-weather-card/weather_icons.zip -d src/main/resources/config/www/custom_ui/bom-weather-card/icons/weather_icons
mkdir -p src/main/resources/config/www/custom_ui/bom-weather-card &&
  cp -rvf ../../../asystem_external/homeassistant/bom-weather-card/bom-weather-card.js src/main/resources/config/www/custom_ui/bom-weather-card &&
...
for FILE in illuminance.yaml lovelace.yaml weather.yaml; do
  mkdir -p src/main/resources/config/www/custom_ui/bom-weather-card &&
    cp -rvf ../../../asystem_external/homeassistant/bom-weather-card/${FILE} src/main/resources/config/www/custom_ui/bom-weather-card &&
...
mkdir -p src/main/resources/config/www/custom_ui/bom-radar-card &&
  cp -rvf ../../../asystem_external/homeassistant/bom-radar-card/dist/* src/main/resources/config/www/custom_ui/bom-radar-card &&
...
mkdir -p src/main/resources/config/custom_components &&
  cp -rvf ../../../asystem_external/homeassistant/ha-average/custom_components/average src/main/resources/config/custom_components

rm -rf src/main/resources/config/custom_components/senseme
mkdir -p src/main/resources/config/custom_components &&
  cp -rvf ../../../asystem_external/homeassistant/senseme-hacs/custom_components/senseme src/main/resources/config/custom_components

rm -rf src/main/resources/config/custom_components/bureau_of_meteorology
mkdir -p src/main/resources/config/custom_components &&
  cp -rvf ../../../asystem_external/homeassistant/bureau_of_meteorology/custom_components/bureau_of_meteorology src/main/resources/config/custom_components

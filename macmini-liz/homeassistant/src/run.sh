...
SERVICE_HOME_OLD=$(ls -dt $(dirname ${SERVICE_HOME})/*/ | head -n 1 2>/dev/null)
SERVICE_HOME_OLDEST=$(ls -dt $(dirname ${SERVICE_HOME})/*/ | tail -n -$(($(ls -dt $(dirname ${SERVICE_HOME})/*/ | wc -l) - 1)) 2>/dev/null)

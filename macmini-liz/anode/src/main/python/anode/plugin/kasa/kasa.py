    ...
    def datagramReceived(self, data, (host, port)):
        try:
            ...
            self.plugin.datum_push(
                "power_Dconsumption__electricity__" + self.name,
                "current", "point",
            ...
            self.plugin.datum_push(
                "energy_Dconsumption__electricity__" + self.name,
                "current", "integral",
            ...
            energy_consumption_alltime_min = self.plugin.datum_get(
                DATUM_QUEUE_MIN, "energy_Dconsumption__electricity__" + self.name, "integral", "Wh", 1, "all_Dtime", 1, "day")

...
VERSION=$VERSION_ABSOLUTE \
  ...
  docker-compose -f /var/lib/asystem/install/$VERSION_ABSOLUTE/macmini-liz/anode/docker-compose.yml \
  --env-file /var/lib/asystem/install/$VERSION_ABSOLUTE/macmini-liz/anode/.env \

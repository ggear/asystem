...
sed -i '' 's/plot_groups = barometer, tempdew, tempfeel, hum, wind, winddir, windvec, rain, ET, UV, radiation, lightning, tempin, humin, tempext, humext, tempext2, humext2, templeaf, wetleaf, tempsoil, moistsoil, pm/plot_groups = tempdew, tempfeel, hum, wind, windvec, rain, tempin, humin/g' src/main/resources/config/skins/Seasons/skin.conf

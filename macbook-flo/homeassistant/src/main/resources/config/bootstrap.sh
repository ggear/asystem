...
#   - Philips Hue (local push, requires internet for firmware upgrades, requires Hue Bridge adotpion button to be pressed)
...
#   - UniFi Protect (local push, no internet, requires Protect IP, user and password config - has not been yaml configured since at least Nov 2020)
#   - Bureau of Meteorology - gooseberry_hill for observations, darlington_forecast for weather forecast, 7 day forecast (cloud polling, requires internet, requires manual configuration)

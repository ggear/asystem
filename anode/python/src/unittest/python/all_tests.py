...
class ANodeTest(TestCase):
    ...
    def setUp(self):
        ...
        shutil.copytree(DIR_ROOT + "/src/unittest/resources/pickle", state_dir + "/anode")
    ...
    #     self.assertRest(0,
    #                     anode,
    #                     "/rest/?scope=history&print=pretty&format=csv&metrics=consumption-peak.g&bins=1all-time",
    #                     True)
    #     self.assertRest(0,
    #                     anode,
    #                     "/rest/?scope=history&print=pretty&format=csv&metrics=consumption-off-peak.g&bins=1all-time",
    #                     True)
    #     self.assertEquals(0,
    #                       self.assertRest(1,
    #                                       anode,
    ...
    #                       self.assertRest(1,
    #                                       anode,
    #                                       "/rest/?scope=history&print=pretty&format=csv&metrics=consumption-peak.g&bins=1day",
    #                                       True)[0]["Grid (1 Day)"][0])
    #     self.assertEquals(0,
    #                       self.assertRest(1,
    #                                       anode,
    ...
    #     anode.stop_server()
    #
    # # TODO: Something broker here when I updated the avro schema, outdoor/indoor -> conditions
...
DIR_TEST = DIR_ROOT + "/src/unittest/resources"

...
class Energyforecast(Plugin):
        ...
        try:
            ...
            if "energyforecastinterday" in model_day_inter and "energyforecastintraday" in model_day_intra and \
                ...
                energy_production_today = self.anode.get_plugin("fronius").datum_get(
                    DATUM_QUEUE_LAST, "energy_Dproduction__electricity__inverter", "integral", "Wh", 1, "day")
                ...
                sun_rise = self.anode.get_plugin("davis").datum_get(
                    DATUM_QUEUE_LAST, "sun__season__rise", "epoch", "scalar", 1, "day")
                ...
                sun_set = self.anode.get_plugin("davis").datum_get(
                    DATUM_QUEUE_LAST, "sun__season__set", "epoch", "scalar", 1, "day")
                ...
                sun_azimuth = self.anode.get_plugin("davis").datum_get(
                    DATUM_QUEUE_LAST, "sun__season__azimuth", "point", "_PC2_PB0", 2, "second")
                ...
                sun_altitude = self.anode.get_plugin("davis").datum_get(
                    DATUM_QUEUE_LAST, "sun__season__altitude", "point", "_PC2_PB0", 2, "second")
                ...
                for day in range(1, 4):
                    temperature_forecast = self.anode.get_plugin("darksky").datum_get(
                        ...
                        "temperature__conditions__forecast", "point", "_PC2_PB0C", day, "day")
                    ...
                    rain_forecast = self.anode.get_plugin("darksky").datum_get(
                        DATUM_QUEUE_MAX if day == 1 else DATUM_QUEUE_LAST,
                        "rain__water__day_Dforecast", "integral", "mm", day, "day_Dtime")
                    ...
                    humidity_forecast = self.anode.get_plugin("darksky").datum_get(
                        DATUM_QUEUE_MAX if day == 1 else DATUM_QUEUE_LAST,
                        "humidity__conditions__forecast", "mean", "_P25", day, "day")
                    ...
                    wind_forecast = self.anode.get_plugin("darksky").datum_get(
                        DATUM_QUEUE_LAST,
                        "wind__conditions__speed_Dforecast", "mean", "km_P2Fh", day, "day")
                    ...
                    conditions_forecast = self.anode.get_plugin("darksky").datum_get(
                        DATUM_QUEUE_LAST,
                        "description__conditions__forecast", "enumeration", "__", day, "day")
                    ...
                    model_features_dict = {
                        ...
                        "energy_Dproduction__electricity__inverter": 0,
                        "temperature__conditions__forecast": temperature_forecast,
                        "rain__water__day_Dforecast": rain_forecast,
                        "humidity__conditions__forecast": humidity_forecast,
                        "wind__conditions__speed_Dforecast": wind_forecast,
                        "sun__season__rise": sun_rise,
                        "sun__season__set": sun_set,
                        "sun__season__azimuth": sun_azimuth,
                        "sun__season__altitude": sun_altitude,
                        "description__conditions__forecast": conditions_forecast
                    }
                    ...
                    for model_version in model_day_inter["energyforecastinterday"]:
                        if model_version >= APP_MODEL_ENERGYFORECAST_INTERDAY_PROD_VERSION:
                            ...
                            if day > 1 or sun_percentage <= 65 or \
                                    self.datum_get(DATUM_QUEUE_LAST, "energy_Dproduction__electricity__forecast" + model_classifier + "__inverter",
                                ...
                                self.datum_push(
                                    "energy_Dproduction__electricity__forecast" + model_classifier + "__inverter",
                            ...
                            if day == 1:
                                ...
                                energy_production_forecast = self.datum_get(DATUM_QUEUE_LAST,
                                                                            "energy_Dproduction__electricity__forecast" + model_classifier +
                                ...
                                energy_production_forecast_scaled_features_dict = \
                                    {"energy_Dproduction__electricity__forecast_Ddaylight_Dinverter": int(sun_percentage * 10)}
                                try:
                                ...
                                self.datum_push(
                                    "energy_Dproduction__electricity__forecast_Dactual" + model_classifier + "__inverter",
                                    "forecast", "point",
    ...
    def __init__(self, parent, name, config, reactor):
        ...
        metric_drop("energy_Dproduction__electricity__forecast")
        metric_drop("energy_Dproduction__electricity__forecast_Dactual")

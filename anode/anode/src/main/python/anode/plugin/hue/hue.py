    ...
    def lights_adjust(self, content):
        ...
        try:
            ...
            for group in self.groups:
                ...
                self.datum_push(
                    "power_Dconsumption__electricity__" + self.groups[group]["name"].lower() + "_Dlights",
                    "current", "point",
                    power_second_bin,
                    "W",
                    1,
                ...
                energy_consumption_day = self.datum_get(
                    DATUM_QUEUE_LAST, "energy_Dconsumption__electricity__" + self.groups[group]["name"].lower() + "_Dlights",
                    "integral", "mWh", "1", "day")
                ...
                self.datum_push(
                    "energy_Dconsumption__electricity__" + self.groups[group]["name"].lower() + "_Dlights",
                    "current", "integral",
                ...
                energy_consumption_alltime_min = self.datum_get(
                    DATUM_QUEUE_MIN, "energy_Dconsumption__electricity__" + self.groups[group]["name"].lower() + "_Dlights",

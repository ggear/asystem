...
class Fronius(Plugin):
    ...
    def push_flow(self, content):
        ...
        try:
            ...
            self.datum_push(
                "power_Dexport__electricity__grid",
                "current", "point",
            ...
            self.datum_push(
                "power_Dproduction__electricity__inverter",
                "current", "point",
            ...
            self.datum_push(
                "power_Dconsumption__electricity__grid",
                "current", "point",
                self.datum_value(dict_content, ["Body", "Data", "Site", "P_Grid"], 0, 1) if self.datum_value(
                    dict_content, ["Body", "Data", "Site", "P_Grid"], 0) >= 0 else 0,
                "W",
            ...
            self.datum_push(
                "power_Dconsumption__electricity__inverter",
                "current", "point",
            ...
            self.datum_push(
                "power_Dutilisation__electricity__inverter",
                "current", "point",
            ...
            self.datum_push(
                "power_Dutilisation__electricity__grid",
                "current", "point",
            ...
            self.datum_push(
                "power_Dutilisation__electricity__array",
                "current", "point",
            ...
            self.datum_push(
                "energy_Dproduction__electricity__inverter",
                "current", "integral",
            ...
            energy_production_inverter_alltime_min = self.datum_get(
                DATUM_QUEUE_MIN, "energy_Dproduction__electricity__inverter", "integral", "Wh", 1, "all_Dtime", 1, "day")
    ...
    def push_meter(self, content):
        ...
        try:
            ...
            energy_export_grid_alltime_min = self.datum_get(
                DATUM_QUEUE_MIN, "energy_Dexport__electricity__grid", "integral", "Wh", 1, "all_Dtime", 1, "day")
            ...
            energy_production_inverter_alltime_last = self.datum_get(
                DATUM_QUEUE_LAST, "energy_Dproduction__electricity__inverter", "integral", "Wh", "1", "all_Dtime")
            energy_production_inverter_alltime_min = self.datum_get(
                DATUM_QUEUE_MIN, "energy_Dproduction__electricity__inverter", "integral", "Wh", 1, "all_Dtime", 1, "day")
            ...
            self.datum_push(
                "energy_Dconsumption__electricity__inverter",
                "current", "integral",
            ...
            self.datum_push(
                "energy_Dconsumption__electricity__grid",
                "current", "integral",
            ...
            energy_consumption_grid_min = self.datum_get(
                DATUM_QUEUE_MIN, "energy_Dconsumption__electricity__grid", "integral", "Wh", 1, "all_Dtime", 1, "day")
            ...
            energy_consumption_shoulder_inverter = self.datum_get(
                DATUM_QUEUE_LAST, "energy_Dconsumption__electricity__shoulder_Dinverter", "integral", "Wh", 1, "all_Dtime")
            energy_consumption_shoulder_grid = self.datum_get(
                DATUM_QUEUE_LAST, "energy_Dconsumption__electricity__shoulder_Dgrid", "integral", "Wh", 1, "all_Dtime")
            ...
            if energy_consumption_shoulder_grid is None and bin_timestamp >= \
                ...
                self.datum_push(
                    "energy_Dconsumption__electricity__shoulder_Dgrid",
                    "current", "integral",
                    energy_consumption_grid_alltime,
                    "Wh",
                    10,
                ...
                self.datum_push(
                    "energy_Dconsumption__electricity__shoulder_Dinverter",
                    "current", "integral",
            ...
            energy_consumption_peak_inverter = self.datum_get(
                DATUM_QUEUE_LAST, "energy_Dconsumption__electricity__peak_Dinverter", "integral", "Wh", 1, "all_Dtime")
            energy_consumption_peak_grid = self.datum_get(
                DATUM_QUEUE_LAST, "energy_Dconsumption__electricity__peak_Dgrid", "integral", "Wh", 1, "all_Dtime")
            ...
            if energy_consumption_peak_grid is None and bin_timestamp >= \
                ...
                self.datum_push(
                    "energy_Dconsumption__electricity__peak_Dgrid",
                    "current", "integral",
                    energy_consumption_grid_alltime,
                    "Wh",
                    10,
                ...
                self.datum_push(
                    "energy_Dconsumption__electricity__peak_Dinverter",
                    "current", "integral",
                    energy_production_inverter_day - energy_export_grid_day,
                    "Wh",
                    10,
            ...
            energy_consumption_offpeak_inverter = self.datum_get(
                DATUM_QUEUE_LAST, "energy_Dconsumption__electricity__off_Dpeak_Dinverter", "integral", "Wh", 1, "all_Dtime")
            energy_consumption_offpeak_grid = self.datum_get(
                DATUM_QUEUE_LAST, "energy_Dconsumption__electricity__off_Dpeak_Dgrid", "integral", "Wh", 1, "all_Dtime")
            ...
            if energy_consumption_offpeak_grid is None and bin_timestamp >= \
                ...
                self.datum_push(
                    "energy_Dconsumption__electricity__off_Dpeak_Dgrid",
                    "current", "integral",
                    energy_consumption_grid_alltime,
                    "Wh",
                    10,
                ...
                self.datum_push(
                    "energy_Dconsumption__electricity__off_Dpeak_Dinverter",
                    "current", "integral",
                    energy_production_inverter_day - energy_export_grid_day,
                    "Wh",
                    10,
            ...
            if energy_consumption_shoulder_grid is None:
                ...
                energy_consumption_offpeak_morning_grid_day = \
                    (energy_consumption_shoulder_grid["data_value"] - energy_consumption_grid_min["data_value"]) \
                        if energy_consumption_grid_min is not None else 0
            self.datum_push(
                "energy_Dconsumption__electricity__off_Dpeak_Dmorning_Dgrid",
                "current", "integral",
                energy_consumption_offpeak_morning_grid_day,
                "Wh",
                10,
            ...
            self.datum_push(
                "energy_Dconsumption__electricity__off_Dpeak_Devening_Dgrid",
                "current", "integral",
            ...
            self.datum_push(
                "energy_Dexport__electricity__yield",
                "current", "integral",
            ...
            self.datum_push(
                "energy_Dconsumption__electricity__savings",
                "current", "integral",
            ...
            self.datum_push(
                "energy_Dconsumption__electricity__cost_Dhome",
                "current", "integral",
            ...
            self.datum_push(
                "energy_Dconsumption__electricity__cost_Dsmart_Dhome",
                "current", "integral",
                self.datum_value(Decimal(SUPPLY_CHARGE) +

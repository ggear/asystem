...
apt-get install -y --allow-downgrades 'docker-ce=5:20.10.22~3-0~debian-bullseye'
apt-get install -y --allow-downgrades 'docker-ce-cli=5:20.10.22~3-0~debian-bullseye'
apt-get install -y --allow-downgrades 'containerd.io=1.6.14-1'
...
apt-get install -y --allow-downgrades 'linux-cpupower=5.10.158-2'

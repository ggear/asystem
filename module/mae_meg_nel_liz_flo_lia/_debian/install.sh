...
apt-get install -y --allow-downgrades 'docker-ce=5:23.0.0-1~debian.11~bullseye'
apt-get install -y --allow-downgrades 'docker-ce-cli=5:23.0.0-1~debian.11~bullseye'

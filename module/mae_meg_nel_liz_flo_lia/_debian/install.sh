...
apt-get install -y --allow-downgrades 'curl=7.74.0-1.3+deb11u5'
...
apt-get install -y --allow-downgrades 'docker-ce=5:20.10.23~3-0~debian-bullseye'
apt-get install -y --allow-downgrades 'docker-ce-cli=5:20.10.23~3-0~debian-bullseye'
apt-get install -y --allow-downgrades 'containerd.io=1.6.16-1'

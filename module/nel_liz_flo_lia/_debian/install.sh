...
apt-get install -y --allow-downgrades 'curl=7.74.0-1.3+deb11u3'
...
apt-get install -y --allow-downgrades 'docker-ce=5:20.10.21~3-0~debian-bullseye'
apt-get install -y --allow-downgrades 'docker-ce-cli=5:20.10.21~3-0~debian-bullseye'
apt-get install -y --allow-downgrades 'containerd.io=1.6.10-1'
...
apt-get install -y --allow-downgrades 'linux-cpupower=5.10.149-2'

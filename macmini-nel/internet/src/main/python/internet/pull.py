...
if __name__ == "__main__":
    ...
    internet_conf_path = os.path.join(DIR_MODULE_ROOT, "internet/mqtt_metadata.csv")
    metadata_internet_df.to_csv(internet_conf_path, index=False)
    print("Build script [internet] entity metadata persisted to [{}]".format(internet_conf_path))

...
#mkdir -p ${ROOT_DIR}/src/main/resources/image/udm-utilities &&
#  cp -rvf  ${ROOT_DIR}/../../../.deps/udmutilities/udm-utilities/on-boot-script ${ROOT_DIR}/src/main/resources/image/udm-utilities &&
#  cp -rvf  ${ROOT_DIR}/../../../.deps/udmutilities/udm-utilities/container-common ${ROOT_DIR}/src/main/resources/image/udm-utilities &&
#  cp -rvf  ${ROOT_DIR}/../../../.deps/udmutilities/udm-utilities/cni-plugins ${ROOT_DIR}/src/main/resources/image/udm-utilities &&
#  cp -rvf  ${ROOT_DIR}/../../../.deps/udmutilities/udm-utilities/dns-common ${ROOT_DIR}/src/main/resources/image/udm-utilities &&
#  cp -rvf  ${ROOT_DIR}/../../../.deps/udmutilities/udm-utilities/run-pihole ${ROOT_DIR}/src/main/resources/image/udm-utilities

...
docker run --name "$CONTAINER_NAME" --user root --entrypoint sh --mount type=bind,source=/Users/graham/Code/asystem/src/meg/digitemp/src/main/python,target=/asystem/bin/python,readonly -dt 'telegraf:1.28.1'

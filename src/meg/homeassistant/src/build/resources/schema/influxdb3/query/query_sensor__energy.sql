...
SELECT
    ...
    round(avg(last_valid_state), 1)  AS "Last Valid State Avg",
    round(min(last_valid_state), 1)  AS "Last Valid State Min",
    round(max(last_valid_state), 1)  AS "Last Valid State Max",

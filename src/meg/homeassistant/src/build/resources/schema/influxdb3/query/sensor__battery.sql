...
-- sensor__battery [Home Assistant sensor__battery] every <on-change>, bucketed [1 day] across the newest two buckets
-- part 1 of 1:
SELECT
...
WHERE
    ...
    AND time >= (SELECT max(time) FROM sensor__battery) - INTERVAL '1 day'

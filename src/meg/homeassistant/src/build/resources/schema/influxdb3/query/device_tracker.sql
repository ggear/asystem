...
SELECT
    ...
    count(altitude)                                          AS "Altitude Count",
    count(DISTINCT altitude)                                 AS "Altitude Distinct",
    ...
    count(battery_level)                                     AS "Battery Level Count",
    count(DISTINCT battery_level)                            AS "Battery Level Distinct"
FROM device_tracker
WHERE

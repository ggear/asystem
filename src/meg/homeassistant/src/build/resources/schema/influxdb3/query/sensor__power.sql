...
-- sensor__power [Home Assistant sensor__power] every <on-change>, bucketed [1 day] across the newest two buckets
-- part 1 of 1:
SELECT
...
WHERE
    ...
    AND time >= (SELECT max(time) FROM sensor__power) - INTERVAL '1 day'

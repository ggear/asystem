...
-- sensor__sound_pressure [Home Assistant sensor__sound_pressure] every <on-change>, bucketed [1 day] across the newest two buckets
-- part 1 of 1:
SELECT
...
WHERE
    ...
    AND time >= (SELECT max(time) FROM sensor__sound_pressure) - INTERVAL '1 day'

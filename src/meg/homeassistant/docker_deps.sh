...
echo "    'homeassistant/home-assistant:2024.12.0'" && echo ""
echo "#######################################################################################"
EOF
...
docker run --name "$CONTAINER_NAME" --user root --platform linux/x86_64 --entrypoint sh  -dt 'homeassistant/home-assistant:2024.12.0'

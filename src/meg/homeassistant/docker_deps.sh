...
echo "    'homeassistant/home-assistant:2025.1.4'" && echo ""
echo "#######################################################################################"
EOF
...
docker run --name "$CONTAINER_NAME" --user root --platform linux/x86_64 --entrypoint sh  -dt 'homeassistant/home-assistant:2025.1.4'

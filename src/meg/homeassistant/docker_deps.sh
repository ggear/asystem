...
docker run --name "$CONTAINER_NAME" --user root --platform linux/x86_64 --entrypoint sh --mount type=bind,source=/Users/graham/Code/asystem/src/meg/homeassistant/src/main/resources/image,target=/asystem/etc,readonly -dt 'homeassistant/home-assistant:2024.12.0'

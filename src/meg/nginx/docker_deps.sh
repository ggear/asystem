...
docker run --name "$CONTAINER_NAME" --user root --platform linux/x86_64 --entrypoint sh --mount type=bind,source=/Users/graham/Code/asystem/src/meg/nginx/src/main/resources/image,target=/asystem/etc,readonly -dt 'nginx:1.27.4-alpine'

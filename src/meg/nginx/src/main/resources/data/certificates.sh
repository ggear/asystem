...
if [ "$1" = "pull" ]; then
  ...
  for DIR in "/home/asystem/nginx/latest" "/var/lib/asystem/install/nginx/latest/data"; do
  ...
  ssh -q -o "StrictHostKeyChecking=no" "root@$3" "/var/lib/asystem/install/nginx/latest/install.sh"

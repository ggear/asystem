...
#######################################################################################
echo ''
if netcat -z 10.0.6.100 80 2>/dev/null; then
	...
	sleep 1 && while ! netcat -z 10.0.6.100 80 2>/dev/null; do sleep 1; done
...
echo ''
if netcat -z 10.0.6.101 80 2>/dev/null; then
	...
	sleep 1 && while ! netcat -z 10.0.6.101 80 2>/dev/null; do sleep 1; done

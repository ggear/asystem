...
if netcat -zw 1 10.0.4.109 80 2>/dev/null; then
	...
	decode-config.py -s 10.0.4.109 -i /Users/graham/Code/asystem/src/meg/tasmota/src/build/resources/devices/rack_screen_plug.json
...
if netcat -zw 1 10.0.4.110 80 2>/dev/null; then
	...
	decode-config.py -s 10.0.4.110 -i /Users/graham/Code/asystem/src/meg/tasmota/src/build/resources/devices/rack_backup_plug.json
...
if netcat -zw 1 10.0.4.111 80 2>/dev/null; then
	...
	decode-config.py -s 10.0.4.111 -i /Users/graham/Code/asystem/src/meg/tasmota/src/build/resources/devices/rack_printer_plug.json

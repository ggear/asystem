...
if netcat -zw 1 10.0.4.100 80 2>/dev/null; then
	...
	decode-config.py -s 10.0.4.100 -i /Users/graham/Code/asystem/src/rue/tasmota/src/build/resources/devices/ceiling_water_booster_plug.json
...
if netcat -zw 1 10.0.4.101 80 2>/dev/null; then
	...
	decode-config.py -s 10.0.4.101 -i /Users/graham/Code/asystem/src/rue/tasmota/src/build/resources/devices/rack_fans_plug.json
...
if netcat -zw 1 10.0.4.102 80 2>/dev/null; then
	...
	decode-config.py -s 10.0.4.102 -i /Users/graham/Code/asystem/src/rue/tasmota/src/build/resources/devices/rack_outlet_plug.json
...
if netcat -zw 1 10.0.4.103 80 2>/dev/null; then
	...
	decode-config.py -s 10.0.4.103 -i /Users/graham/Code/asystem/src/rue/tasmota/src/build/resources/devices/kitchen_bench_lights_plug.json
...
if netcat -zw 1 10.0.4.104 80 2>/dev/null; then
	...
	decode-config.py -s 10.0.4.104 -i /Users/graham/Code/asystem/src/rue/tasmota/src/build/resources/devices/kitchen_fan_plug.json
...
if netcat -zw 1 10.0.4.105 80 2>/dev/null; then
	...
	decode-config.py -s 10.0.4.105 -i /Users/graham/Code/asystem/src/rue/tasmota/src/build/resources/devices/ceiling_network_switch_plug.json
...
if netcat -zw 1 10.0.4.106 80 2>/dev/null; then
	...
	decode-config.py -s 10.0.4.106 -i /Users/graham/Code/asystem/src/rue/tasmota/src/build/resources/devices/garden_pool_filter_plug.json
...
if netcat -zw 1 10.0.4.107 80 2>/dev/null; then
	...
	decode-config.py -s 10.0.4.107 -i /Users/graham/Code/asystem/src/rue/tasmota/src/build/resources/devices/deck_festoons_plug.json
...
if netcat -zw 1 10.0.4.108 80 2>/dev/null; then
	...
	decode-config.py -s 10.0.4.108 -i /Users/graham/Code/asystem/src/rue/tasmota/src/build/resources/devices/landing_festoons_plug.json
...
echo ''
if netcat -zw 1 10.0.4.109 80 2>/dev/null; then
	echo 'Processing config for device [rack_screen_plug] at [http://10.0.4.109/?] ... '
	echo 'Current firmware ['"$(curl -s -m 5 http://10.0.4.109/cm? --data-urlencode 'cmnd=Status 2' | jq -r .StatusFWR.Version | cut -f1 -d\()"'] versus required [13.0.0]'
	decode-config.py -s 10.0.4.109 -i /Users/graham/Code/asystem/src/rue/tasmota/src/build/resources/devices/rack_screen_plug.json
	sleep 1 && while ! netcat -zw 1 10.0.4.109 80 2>/dev/null; do echo 'Waiting for device [rack_screen_plug] to come up ...' && sleep 1; done
	if [ "$(curl -s -m 5 http://10.0.4.109/cm? --data-urlencode 'cmnd=PowerOnState' | grep '{"PowerOnState":0}' | wc -l)" -ne 1 ]; then
		printf 'Config set [PowerOnState] to [0] with response: ' && curl -s -m 5 http://10.0.4.109/cm? --data-urlencode 'cmnd=PowerOnState 0'
		echo ''
	else
		echo 'Config set skipped, [PowerOnState] already set to [0]'
	fi
	if [ "$(curl -s -m 5 http://10.0.4.109/cm? --data-urlencode 'cmnd=PowerRetain' | grep '{"PowerRetain":"ON"}' | wc -l)" -ne 1 ]; then
		printf 'Config set [PowerRetain] to [ON] with response: ' && curl -s -m 5 http://10.0.4.109/cm? --data-urlencode 'cmnd=PowerRetain ON'
		echo ''
	else
		echo 'Config set skipped, [PowerRetain] already set to [ON]'
	fi
...
echo ''
if netcat -zw 1 10.0.4.110 80 2>/dev/null; then
	echo 'Processing config for device [rack_backup_plug] at [http://10.0.4.110/?] ... '
	echo 'Current firmware ['"$(curl -s -m 5 http://10.0.4.110/cm? --data-urlencode 'cmnd=Status 2' | jq -r .StatusFWR.Version | cut -f1 -d\()"'] versus required [13.0.0]'
	decode-config.py -s 10.0.4.110 -i /Users/graham/Code/asystem/src/rue/tasmota/src/build/resources/devices/rack_backup_plug.json
	sleep 1 && while ! netcat -zw 1 10.0.4.110 80 2>/dev/null; do echo 'Waiting for device [rack_backup_plug] to come up ...' && sleep 1; done
	if [ "$(curl -s -m 5 http://10.0.4.110/cm? --data-urlencode 'cmnd=PowerOnState' | grep '{"PowerOnState":0}' | wc -l)" -ne 1 ]; then
		printf 'Config set [PowerOnState] to [0] with response: ' && curl -s -m 5 http://10.0.4.110/cm? --data-urlencode 'cmnd=PowerOnState 0'
		echo ''
	else
		echo 'Config set skipped, [PowerOnState] already set to [0]'
	fi
	if [ "$(curl -s -m 5 http://10.0.4.110/cm? --data-urlencode 'cmnd=PowerRetain' | grep '{"PowerRetain":"ON"}' | wc -l)" -ne 1 ]; then
		printf 'Config set [PowerRetain] to [ON] with response: ' && curl -s -m 5 http://10.0.4.110/cm? --data-urlencode 'cmnd=PowerRetain ON'
		echo ''
	else
		echo 'Config set skipped, [PowerRetain] already set to [ON]'
	fi
...
if netcat -zw 1 10.0.4.111 80 2>/dev/null; then
	...
	decode-config.py -s 10.0.4.111 -i /Users/graham/Code/asystem/src/rue/tasmota/src/build/resources/devices/rack_printer_plug.json

        ...
        for file_name in file_names:
            ...
            for file_probe_stream in file_probe["streams"]:
                ...
                if file_probe_stream_type == "video":
                    ...
                    file_probe_stream_video_resolution = "UNKNOWN"
                    file_probe_stream_video_width = file_probe_stream["width"]
                    file_probe_stream_video_height = file_probe_stream["height"]
                    ...
                    file_probe_stream_filtered.append({"language": file_probe_stream["tags"]["language"].lower() \
                        if "tags" in file_probe_stream else "unknown"})

...
for HOST in ${HOSTS}; do
  ...
  ssh -o StrictHostKeyChecking=no root@${HOST} "/root/install/media/latest/config/clean.sh"
  ssh -o StrictHostKeyChecking=no root@${HOST} "/root/install/media/latest/config/media.sh"

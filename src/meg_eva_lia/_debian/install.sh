...
apt-get -y --allow-downgrades install docker-ce=5:28.0.1-1~debian.12~bookworm
apt-get -y --allow-downgrades install docker-ce-cli=5:28.0.1-1~debian.12~bookworm
...
apt-get -y --allow-downgrades install linux-cpupower=6.1.128-1
...
apt-get -y --allow-downgrades install locales=2.36-9+deb12u9

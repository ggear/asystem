...
apt-get install -y --allow-downgrades 'docker-ce=5:25.0.3-1~debian.12~bookworm'
apt-get install -y --allow-downgrades 'docker-ce-cli=5:25.0.3-1~debian.12~bookworm'
...
apt-get install -y --allow-downgrades 'linux-cpupower=6.1.76-1'

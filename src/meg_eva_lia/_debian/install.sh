...
apt-get -y --allow-downgrades install net-tools=2.10-0.1+deb12u1
...
apt-get -y --allow-downgrades install docker-ce=5:28.1.1-1~debian.12~bookworm
apt-get -y --allow-downgrades install docker-ce-cli=5:28.1.1-1~debian.12~bookworm
...
apt-get -y --allow-downgrades install linux-cpupower=6.1.137-1

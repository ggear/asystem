...
apt-get -y --allow-downgrades install docker-ce=5:28.2.2-1~debian.12~bookworm
apt-get -y --allow-downgrades install docker-ce-cli=5:28.2.2-1~debian.12~bookworm

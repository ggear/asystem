...
apt-get -y --allow-downgrades install ca-certificates=20230311
...
apt-get -y --allow-downgrades install docker-ce=5:28.0.4-1~debian.12~bookworm
apt-get -y --allow-downgrades install docker-ce-cli=5:28.0.4-1~debian.12~bookworm
apt-get -y --allow-downgrades install containerd.io=1.7.26-1
...
apt-get -y --allow-downgrades install linux-cpupower=6.1.129-1
...
apt-get -y --allow-downgrades install xz-utils=5.4.1-0.2
...
apt-get -y --allow-downgrades install libssl-dev=3.0.15-1~deb12u1
...
apt-get -y --allow-downgrades install liblzma-dev=5.4.1-0.2

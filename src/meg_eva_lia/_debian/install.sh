...
apt-get install -y --allow-downgrades 'dnsutils=1:9.18.24-1'
...
apt-get install -y --allow-downgrades 'docker-ce=5:26.1.4-1~debian.12~bookworm'
apt-get install -y --allow-downgrades 'docker-ce-cli=5:26.1.4-1~debian.12~bookworm'
apt-get install -y --allow-downgrades 'containerd.io=1.6.33-1'
...
apt-get install -y --allow-downgrades 'linux-cpupower=6.1.90-1'
...
apt-get install -y --allow-downgrades 'ffmpeg=7:5.1.5-0+deb12u1'
apt-get install -y --allow-downgrades 'powertop=2.14-1+b2'
apt-get install -y --allow-downgrades 'locales=2.36-9+deb12u7'
...
apt-get install -y --allow-downgrades 'libssl-dev=3.0.11-1~deb12u2'

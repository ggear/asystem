...
apt-get install -y --allow-downgrades 'docker-ce=5:27.2.1-1~debian.12~bookworm'
apt-get install -y --allow-downgrades 'docker-ce-cli=5:27.2.1-1~debian.12~bookworm'

...
apt-get install -y --allow-downgrades 'curl=7.88.1-10+deb12u6'
...
apt-get install -y --allow-downgrades 'docker-ce=5:27.0.3-1~debian.12~bookworm'
apt-get install -y --allow-downgrades 'docker-ce-cli=5:27.0.3-1~debian.12~bookworm'
...
apt-get install -y --allow-downgrades 'linux-cpupower=6.1.99-1'
...
apt-get install -y --allow-downgrades 'libssl-dev=3.0.13-1~deb12u1'

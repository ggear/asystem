...
docker run --name "$CONTAINER_NAME" --user root --platform linux/x86_64 --entrypoint sh --mount type=bind,source=/Users/graham/Code/asystem/src/meg_eva_lia/monitor/src/main/resources/image,target=/asystem/etc,readonly -dt 'telegraf:1.32.3'

...
docker run --name "$CONTAINER_NAME" --user root --platform linux/x86_64 --entrypoint sh --mount type=bind,source=/Users/graham/Code/asystem/src/eva/letsencrypt/src/main/resources/image,target=/asystem/etc,readonly -dt 'adferrand/dnsrobocert:3.25.0'

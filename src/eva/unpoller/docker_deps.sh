...
docker run --name "$CONTAINER_NAME" --user root --entrypoint sh --mount type=bind,source=/Users/graham/Code/asystem/src/eva/unpoller/src/main/resources/image,target=/asystem/etc,readonly -dt 'debian:12.8-slim'

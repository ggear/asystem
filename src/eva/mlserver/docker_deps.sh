...
docker run --name "$CONTAINER_NAME" --user root --entrypoint sh --mount type=bind,source=/Users/graham/Code/asystem/src/eva/mlserver/src/main/python,target=/asystem/bin/python,readonly -dt 'python:3.12.7-slim-bookworm'

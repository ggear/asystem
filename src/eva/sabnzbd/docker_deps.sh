...
echo "    'linuxserver/sabnzbd:4.4.1'" && echo ""
echo "#######################################################################################"
EOF
...
docker run --name "$CONTAINER_NAME" --user root --platform linux/x86_64 --entrypoint sh --mount type=bind,source=/Users/graham/Code/asystem/src/eva/sabnzbd/src/main/resources/image,target=/asystem/etc,readonly -dt 'linuxserver/sabnzbd:4.4.1'

...
cp -rvf /var/lib/asystem/install/media/latest/config/rename.py /home/asystem/sabnzbd/latest/scripts
cp -rvf /var/lib/asystem/install/media/latest/config/normalise.sh /home/asystem/sabnzbd/latest/scripts

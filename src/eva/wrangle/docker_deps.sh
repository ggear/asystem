...
docker run --name "$CONTAINER_NAME" --user root --entrypoint sh --mount type=bind,source=/Users/graham/Code/asystem/src/eva/wrangle/src/main/python,target=/asystem/bin/python,readonly -dt 'telegraf:1.32.3'

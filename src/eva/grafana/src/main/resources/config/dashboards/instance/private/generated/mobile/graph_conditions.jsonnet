...
from(bucket: "home_private")
|> range(start: v.timeRangeStart, stop: v.timeRangeStop)
|> filter(fn: (r) => r["entity_id"] == "compensation_sensor_roof_temperature" or r["entity_id"] == "compensation_sensor_ada_temperature" or r["entity_id"] == "compensation_sensor_edwin_temperature" or r["entity_id"] == "compensation_sensor_parents_temperature" or r["entity_id"] == "compensation_sensor_office_office_office_lounge_temperature" or r["entity_id"] == "compensation_sensor_office_temperature" or r["entity_id"] == "compensation_sensor_kitchen_temperature" or r["entity_id"] == "compensation_sensor_office_office_office_pantry_temperature" or r["entity_id"] == "compensation_sensor_office_office_office_dining_temperature" or r["entity_id"] == "compensation_sensor_laundry_temperature" or r["entity_id"] == "compensation_sensor_wardrobe_temperature" or r["entity_id"] == "compensation_sensor_utility_temperature" or r["entity_id"] == "deck_festoons_plug_temperature" or r["entity_id"] == "compensation_sensor_deck_festoons_plug_temperature" or r["entity_id"] == "compensation_sensor_office_office_office_basement_temperature")
|> filter(fn: (r) => r["_field"] == "value")
...
from(bucket: "home_private")
|> range(start: v.timeRangeStart, stop: v.timeRangeStop)
|> filter(fn: (r) => r["entity_id"] == "roof_humidity" or r["entity_id"] == "ada_humidity" or r["entity_id"] == "edwin_humidity" or r["entity_id"] == "office_office_office_lounge_humidity" or r["entity_id"] == "parents_humidity" or r["entity_id"] == "office_humidity" or r["entity_id"] == "kitchen_humidity" or r["entity_id"] == "office_office_office_pantry_humidity" or r["entity_id"] == "office_office_office_dining_humidity" or r["entity_id"] == "laundry_humidity" or r["entity_id"] == "wardrobe_humidity" or r["entity_id"] == "office_office_office_basement_humidity")
|> filter(fn: (r) => r["_field"] == "value")
|> keep(columns: ["_time", "_value", "friendly_name"])
|> aggregateWindow(every: v.windowPeriod, fn: mean, createEmpty: false)
                  '))
...
from(bucket: "home_private")
|> range(start: v.timeRangeStart, stop: v.timeRangeStop)
|> filter(fn: (r) => r["entity_id"] == "edwin_co2" or r["entity_id"] == "office_co2" or r["entity_id"] == "office_office_office_lounge_co2" or r["entity_id"] == "kitchen_co2" or r["entity_id"] == "office_office_office_pantry_co2" or r["entity_id"] == "office_office_office_dining_co2")
|> filter(fn: (r) => r["_field"] == "value")
|> keep(columns: ["_time", "_value", "friendly_name"])
|> aggregateWindow(every: v.windowPeriod, fn: mean, createEmpty: false)
                  '))

...
export GRAFANA_URL=http://${GRAFANA_USER}:${GRAFANA_KEY}@${GRAFANA_SERVICE_PROD}:${GRAFANA_HTTP_PORT}
export GRAFANA_URL_PUBLIC=http://${GRAFANA_USER_PUBLIC}:${GRAFANA_KEY_PUBLIC}@${GRAFANA_SERVICE_PROD}:${GRAFANA_HTTP_PORT}
export GRAFANA_URL_PRIVATE=http://${GRAFANA_USER_PRIVATE}:${GRAFANA_KEY_PRIVATE}@${GRAFANA_SERVICE_PROD}:${GRAFANA_HTTP_PORT}

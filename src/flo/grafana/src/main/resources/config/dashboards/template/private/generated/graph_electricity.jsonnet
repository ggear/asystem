...
from(bucket: "home_private")
|> range(start: v.timeRangeStart, stop: v.timeRangeStop)
|> filter(fn: (r) => r["entity_id"] == "lights_power" or r["entity_id"] == "fans_power" or r["entity_id"] == "all_standby_power" or r["entity_id"] == "coffee_machine_power" or r["entity_id"] == "battery_charger_power" or r["entity_id"] == "vacuum_charger_power" or r["entity_id"] == "pool_filter_power" or r["entity_id"] == "water_booster_power" or r["entity_id"] == "dish_washer_power" or r["entity_id"] == "clothes_dryer_power" or r["entity_id"] == "washing_machine_power" or r["entity_id"] == "kitchen_fridge_power" or r["entity_id"] == "deck_freezer_power" or r["entity_id"] == "towel_rails_power" or r["entity_id"] == "study_outlet_power" or r["entity_id"] == "office_outlet_power" or r["entity_id"] == "audio_visual_devices_power" or r["entity_id"] == "servers_network_power")
|> filter(fn: (r) => r["_field"] == "value")
|> keep(columns: ["_time", "_value", "friendly_name"])
|> aggregateWindow(every: v.windowPeriod, fn: mean, createEmpty: true)
                  '))
...
from(bucket: "home_private")
|> range(start: v.timeRangeStart, stop: v.timeRangeStop)
|> filter(fn: (r) => r["entity_id"] == "lights_energy_daily" or r["entity_id"] == "fans_energy_daily" or r["entity_id"] == "all_standby_energy_daily" or r["entity_id"] == "coffee_machine_energy_daily" or r["entity_id"] == "battery_charger_energy_daily" or r["entity_id"] == "vacuum_charger_energy_daily" or r["entity_id"] == "pool_filter_energy_daily" or r["entity_id"] == "water_booster_energy_daily" or r["entity_id"] == "dish_washer_energy_daily" or r["entity_id"] == "clothes_dryer_energy_daily" or r["entity_id"] == "washing_machine_energy_daily" or r["entity_id"] == "kitchen_fridge_energy_daily" or r["entity_id"] == "deck_freezer_energy_daily" or r["entity_id"] == "towel_rails_energy_daily" or r["entity_id"] == "study_outlet_energy_daily" or r["entity_id"] == "office_outlet_energy_daily" or r["entity_id"] == "audio_visual_devices_energy_daily" or r["entity_id"] == "servers_network_energy_daily")
|> filter(fn: (r) => r["_field"] == "value")
|> keep(columns: ["_time", "_value", "friendly_name"])
|> aggregateWindow(every: v.windowPeriod, fn: mean, createEmpty: false)
                  '))

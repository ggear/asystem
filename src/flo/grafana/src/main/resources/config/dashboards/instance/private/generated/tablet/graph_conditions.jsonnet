...
from(bucket: "home_private")
|> range(start: v.timeRangeStart, stop: v.timeRangeStop)
|> filter(fn: (r) => r["entity_id"] == "compensation_sensor_roof_humidity" or r["entity_id"] == "compensation_sensor_ada_humidity" or r["entity_id"] == "compensation_sensor_edwin_humidity" or r["entity_id"] == "compensation_sensor_bertram_2_office_lounge_humidity" or r["entity_id"] == "compensation_sensor_parents_humidity" or r["entity_id"] == "compensation_sensor_bertram_2_office_humidity" or r["entity_id"] == "compensation_sensor_bertram_2_kitchen_humidity" or r["entity_id"] == "compensation_sensor_bertram_2_office_pantry_humidity" or r["entity_id"] == "compensation_sensor_bertram_2_office_dining_humidity" or r["entity_id"] == "compensation_sensor_laundry_humidity" or r["entity_id"] == "compensation_sensor_bertram_2_office_basement_humidity")
|> filter(fn: (r) => r["_field"] == "value")
|> keep(columns: ["_time", "_value", "friendly_name"])
|> aggregateWindow(every: v.windowPeriod, fn: mean, createEmpty: false)
                  '))
...
from(bucket: "home_private")
|> range(start: v.timeRangeStart, stop: v.timeRangeStop)
|> filter(fn: (r) => r["entity_id"] == "compensation_sensor_edwin_co2" or r["entity_id"] == "compensation_sensor_parents_co2" or r["entity_id"] == "compensation_sensor_bertram_2_office_co2" or r["entity_id"] == "compensation_sensor_bertram_2_office_lounge_co2" or r["entity_id"] == "compensation_sensor_bertram_2_kitchen_co2" or r["entity_id"] == "compensation_sensor_bertram_2_office_pantry_co2" or r["entity_id"] == "compensation_sensor_bertram_2_office_dining_co2")
|> filter(fn: (r) => r["_field"] == "value")
|> keep(columns: ["_time", "_value", "friendly_name"])
|> aggregateWindow(every: v.windowPeriod, fn: mean, createEmpty: false)
                  '))
...
from(bucket: "home_private")
|> range(start: v.timeRangeStart, stop: v.timeRangeStop)
|> filter(fn: (r) => r["entity_id"] == "compensation_sensor_ada_noise" or r["entity_id"] == "compensation_sensor_edwin_noise" or r["entity_id"] == "compensation_sensor_parents_noise" or r["entity_id"] == "compensation_sensor_bertram_2_office_noise" or r["entity_id"] == "compensation_sensor_bertram_2_kitchen_noise" or r["entity_id"] == "compensation_sensor_laundry_noise")
|> filter(fn: (r) => r["_field"] == "value")
|> keep(columns: ["_time", "_value", "friendly_name"])
|> aggregateWindow(every: v.windowPeriod, fn: mean, createEmpty: false)
                  '))

...
apt-get install -y --allow-downgrades 'curl=7.88.1-10'
...
apt-get install -y --allow-downgrades 'docker-ce=5:24.0.2-1~debian.12~bookworm'
apt-get install -y --allow-downgrades 'docker-ce-cli=5:24.0.2-1~debian.12~bookworm'
apt-get install -y --allow-downgrades 'containerd.io=1.6.21-1'
apt-get install -y --allow-downgrades 'cifs-utils=2:7.0-2'
apt-get install -y --allow-downgrades 'samba=2:4.17.8+dfsg-2'
apt-get install -y --allow-downgrades 'cups=2.4.2-3'
apt-get install -y --allow-downgrades 'smbclient=2:4.17.8+dfsg-2'
...
apt-get install -y --allow-downgrades 'linux-cpupower=6.1.27-1'
...
apt-get install -y --allow-downgrades 'locales=2.36-9'

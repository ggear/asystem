...
${ROOT_DIR}/mqtt_config.py '0x2c1165fffe12d5c4' 'Hallway Sconces Bulb 1' 'Hallway Sconces' '{ "power_on_behavior":"on", "color_temp_startup":65279 }'
${ROOT_DIR}/mqtt_config.py '0x2c1165fffe109407' 'Hallway Sconces Bulb 2' 'Hallway Sconces' '{ "power_on_behavior":"on", "color_temp_startup":65279 }'
...
${ROOT_DIR}/mqtt_config.py '0x001788010ec76d57' 'Lounge Lamp Bulb 1' 'Lounge Lamp' '{ "hue_power_on_behavior":"on", "hue_power_on_brightness":3, "hue_power_on_color_temperature":454, "color_temp_startup":454 }'
${ROOT_DIR}/mqtt_config.py '0x0017880106bc4f2d' 'Lounge Reading Bulb 1' 'Lounge Reading' '{ "hue_power_on_behavior":"on", "hue_power_on_brightness":3, "hue_power_on_color_temperature":454, "color_temp_startup":454 }'
...
${ROOT_DIR}/mqtt_config.py '0x2c1165fffeb07271' 'Parents Jane Bedside Bulb 1' 'Parents Jane Bedside' '{ "power_on_behavior":"on", "color_temp_startup":65279 }'
${ROOT_DIR}/mqtt_config.py '0x2c1165fffea8c4d8' 'Parents Graham Bedside Bulb 1' 'Parents Graham Bedside' '{ "power_on_behavior":"on", "color_temp_startup":65279 }'
...
${ROOT_DIR}/mqtt_config.py '0x2c1165fffe2787f0' 'Bathroom Sconces Bulb 1' 'Bathroom Sconces' '{ "power_on_behavior":"on", "color_temp_startup":65279 }'
${ROOT_DIR}/mqtt_config.py '0x2c1165fffe18e424' 'Bathroom Sconces Bulb 2' 'Bathroom Sconces' '{ "power_on_behavior":"on", "color_temp_startup":65279 }'
...
${ROOT_DIR}/mqtt_config.py '0x2c1165fffe168c7e' 'Ensuite Sconces Bulb 1' 'Ensuite Sconces' '{ "power_on_behavior":"on", "color_temp_startup":65279 }'
${ROOT_DIR}/mqtt_config.py '0x2c1165fffea5cd4b' 'Ensuite Sconces Bulb 2' 'Ensuite Sconces' '{ "power_on_behavior":"on", "color_temp_startup":65279 }'
${ROOT_DIR}/mqtt_config.py '0x2c1165fffea89f5f' 'Ensuite Sconces Bulb 3' 'Ensuite Sconces' '{ "power_on_behavior":"on", "color_temp_startup":65279 }'

...
ssh -n -q -o "StrictHostKeyChecking=no" root@nullsvr-zzz "find /var/lib/asystem/install/appdaemon/latest/config -name certificates.sh -exec {} pull macmini-may nullsvr-zzz \;"
ssh -n -q -o "StrictHostKeyChecking=no" root@nullsvr-zzz "find /var/lib/asystem/install/appdaemon/latest/config -name certificates.sh -exec {} push macmini-may nullsvr-zzz \;"

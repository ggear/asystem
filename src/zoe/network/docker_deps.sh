...
docker run --name "$CONTAINER_NAME" --user root --entrypoint sh --mount type=bind,source=/Users/graham/Code/asystem/src/zoe/network/src/main/go,target=/asystem/bin/go,readonly -dt 'golang:1.21.6-alpine'

...
service3    11%  12%  X   X   service4    10% 100%  X   X  ||
service5    10% 100%  X   O   service6    10% 100%  O   X  ||
service7    20%  21%  X   O   service8    10% 100%  X   X  ||
service90~   0%   1%  X   X   ~             ~    ~  ~   ~  ||
*/
...
func compactDisplayLayout() [][]box {
	...
	d_1_0 := box{lblMid: "Used CPU ", valLen: 3, lblRhs: "%", metricID: metric.MetricHostUsedProcessor}
	d_1_1 := box{lblMid: "Fail SVC ", valLen: 3, lblRhs: "%", lblLhs: "  ", metricID: metric.MetricHostFailedServices, resizeInc: resizeLblLhs1}
	d_1_2 := box{lblMid: "Warn TEM ", valLen: 3, lblRhs: "%", lblLhs: "  ", metricID: metric.MetricHostWarnTemperatureOfMax, resizeInc: resizeLblLhs1}
	d_1_3 := box{lblMid: "Used SYS ", valLen: 3, lblRhs: "%", lblLhs: "  ", metricID: metric.MetricHostUsedSystemSpace, resizeInc: resizeLblLhs1}

	d_2_0 := box{lblMid: "Used RAM ", valLen: 3, lblRhs: "%", metricID: metric.MetricHostUsedMemory}
	d_2_1 := box{lblMid: "Fail SHR ", valLen: 3, lblRhs: "%", lblLhs: "  ", metricID: metric.MetricHostFailedShares, resizeInc: resizeLblLhs1}
	d_2_2 := box{lblMid: "Revs Fan ", valLen: 3, lblRhs: "%", lblLhs: "  ", metricID: metric.MetricHostSpinFanSpeedOfMax, resizeInc: resizeLblLhs1}
	d_2_3 := box{lblMid: "Used SHR ", valLen: 3, lblRhs: "%", lblLhs: "  ", metricID: metric.MetricHostUsedShareSpace, resizeInc: resizeLblLhs1}

	d_3_0 := box{lblMid: "Aloc RAM ", valLen: 3, lblRhs: "%", metricID: metric.MetricHostAllocatedMemory}
	d_3_1 := box{lblMid: "Fail BCK ", valLen: 3, lblRhs: "%", lblLhs: "  ", metricID: metric.MetricHostFailedBackups, resizeInc: resizeLblLhs1}
	d_3_2 := box{lblMid: "Life SSD ", valLen: 3, lblRhs: "%", lblLhs: "  ", metricID: metric.MetricHostLifeUsedDrives, resizeInc: resizeLblLhs1}
	d_3_3 := box{lblMid: "Used BKP ", valLen: 3, lblRhs: "%", lblLhs: "  ", metricID: metric.MetricHostUsedBackupSpace, resizeInc: resizeLblLhs1}
	...
	d_X_1 := box{lblRhs: "% ", valLen: 3, valOpt: true, metricID: metric.MetricServiceUsedProcessor}
	d_X_2 := box{lblRhs: "% ", valLen: 3, valOpt: true, metricID: metric.MetricServiceUsedMemory}
	d_X_3 := box{lblLhs: " ", valLen: 1, lblRhs: "  ", valOpt: true, metricID: metric.MetricServiceBackupStatus}
	d_X_4 := box{lblLhs: " ", valLen: 1, lblRhs: " ", valOpt: true, metricID: metric.MetricService}
...
func relaxedDisplayLayout() [][]box {
	...
	d_1_0 := box{lblMid: "Used CPU ", valLen: 8, lblRhs: "%", valKind: valHist, metricID: metric.MetricHostUsedProcessor, resizeInc: resizeHistVal}
	d_1_1 := box{lblMid: "Fail SVC ", valLen: 8, lblRhs: "%", valKind: valHist, lblLhs: "    ", metricID: metric.MetricHostFailedServices, resizeInc: resizeHistVal}
	d_1_2 := box{lblMid: "Warn TEM ", valLen: 8, lblRhs: "%", valKind: valHist, lblLhs: "    ", metricID: metric.MetricHostWarnTemperatureOfMax, resizeInc: resizeHistVal}
	d_1_3 := box{lblMid: "Used SYS ", valLen: 8, lblRhs: "%", valKind: valHist, lblLhs: "    ", metricID: metric.MetricHostUsedSystemSpace, resizeInc: resizeHistVal}

	d_2_0 := box{lblMid: "Used RAM ", valLen: 8, lblRhs: "%", valKind: valHist, metricID: metric.MetricHostUsedMemory, resizeInc: resizeHistVal}
	d_2_1 := box{lblMid: "Fail SHR ", valLen: 8, lblRhs: "%", valKind: valHist, lblLhs: "    ", metricID: metric.MetricHostFailedShares, resizeInc: resizeHistVal}
	d_2_2 := box{lblMid: "Revs Fan ", valLen: 8, lblRhs: "%", valKind: valHist, lblLhs: "    ", metricID: metric.MetricHostSpinFanSpeedOfMax, resizeInc: resizeHistVal}
	d_2_3 := box{lblMid: "Used SHR ", valLen: 8, lblRhs: "%", valKind: valHist, lblLhs: "    ", metricID: metric.MetricHostUsedShareSpace, resizeInc: resizeHistVal}

	d_3_0 := box{lblMid: "Aloc RAM ", valLen: 8, lblRhs: "%", valKind: valHist, metricID: metric.MetricHostAllocatedMemory, resizeInc: resizeHistVal}
	d_3_1 := box{lblMid: "Fail BCK ", valLen: 8, lblRhs: "%", valKind: valHist, lblLhs: "    ", metricID: metric.MetricHostFailedBackups, resizeInc: resizeHistVal}
	d_3_2 := box{lblMid: "Life SSD ", valLen: 8, lblRhs: "%", valKind: valHist, lblLhs: "    ", metricID: metric.MetricHostLifeUsedDrives, resizeInc: resizeHistVal}
	d_3_3 := box{lblMid: "Used BKP ", valLen: 8, lblRhs: "%", valKind: valHist, lblLhs: "    ", metricID: metric.MetricHostUsedBackupSpace, resizeInc: resizeHistVal}
	...
	d_X_2 := box{lblLhs: "   ", lblRhs: "%", valLen: 10, valOpt: true, valKind: valHist, metricID: metric.MetricServiceUsedProcessor, resizeCnt: 2, resizeInc: resizeHistVal}
	d_X_3 := box{lblLhs: "   ", lblRhs: "%", valLen: 10, valOpt: true, valKind: valHist, metricID: metric.MetricServiceUsedMemory, resizeCnt: 2, resizeInc: resizeHistVal}
...
func (b *box) drawValue(display *Display) {
	...
	if record.Value.Pulse == nil || record.Value.Pulse.IsZero() {
		return
	}
	...
	display.terminal.draw(
		location.rows,
		location.cols,
		pad(record.Value.Pulse.String(), b.valAln, b.valLen),

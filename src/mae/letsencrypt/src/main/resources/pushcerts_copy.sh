...
ssh -q -o "StrictHostKeyChecking=no" root@${NGINX_HOST} "cd /var/lib/asystem/install/nginx/latest && docker-compose --compatibility restart"
...
ssh -q -o "StrictHostKeyChecking=no" root@${UDMUTILITIES_HOST} "unifi-os restart"

...
pull_repo "${ROOT_DIR}" weewx weewx-core weewx/weewx v${WEEWX_VERSION} ${1}
...
VERSION=master
pull_repo "${ROOT_DIR}" weewx weewx-mqtt matthewwall/weewx-mqtt "${VERSION}" "${1}"
...
pull_repo "${ROOT_DIR}" weewx weewx-core-skins ggear/weewx "${VERSION}" "${1}"
...
pull_repo "${ROOT_DIR}" weewx neowx-material ggear/neowx-material "${VERSION}" "${1}"

...
mkdir -p ${ROOT_DIR}/src/main/resources/image/bin
cp -nv ${ROOT_DIR}/../../../.deps/weewx/weewx-core/dist/weewx*.whl ${ROOT_DIR}/src/main/resources/image/bin
...
mkdir -p ${ROOT_DIR}/src/main/resources/image/bin
cp -nv ${ROOT_DIR}/../../../.deps/weewx/weewx-mqtt/weewx-mqtt.zip~ ${ROOT_DIR}/src/main/resources/image/bin/weewx-mqtt.zip

...
docker run --name "$CONTAINER_NAME" --user root --platform linux/arm64 --entrypoint sh --mount type=bind,source=/Users/graham/Code/asystem/src/lia/weewx/src/main/python,target=/asystem/bin/python,readonly -dt 'python:3.12.7-slim-bookworm'

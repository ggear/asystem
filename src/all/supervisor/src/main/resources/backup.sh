...
BACKUP_PUB_MODULE="supervisor"
BACKUP_PUB_SOURCE="${SERVICE_DATA_DIR:-/home/asystem/supervisor/latest}"
...
backup_written() {
  backup_target "${BACKUP_PUB_FULL}" "log" || return 1
  ...
  echo "TODO: Provide implementation" >"${BACKUP_PUB_TARGET}.tmp"
  return 1
}

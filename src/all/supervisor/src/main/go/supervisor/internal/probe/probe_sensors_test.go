...
func TestProbeSensors_DiscoverTier(t *testing.T) {
	tests := []struct {
		name           string
...
func TestProbeSensors_Celsius(t *testing.T) {
	tests := []struct {
		name          string
		devices       []sensorDevice
		removeInputs  bool
...
func TestProbeSensors_FanSpeedOfMax(t *testing.T) {
	tests := []struct {
		name          string
...
func TestProbeSensors_LoadIsCachedPerRoot(t *testing.T) {
	t.Cleanup(resetSensors)
...
func TestProbeSensors_DiscoveryIsNeverRepeated(t *testing.T) {
	t.Cleanup(resetSensors)

...
var metricBuildersByID = []builder{
	...
	MetricHostUsedMemory: {
		...
		valueKind:   ValueInt,
		unit:        "%",
		description: "memory in use as a share of the total memory of the host",
	...
	MetricHostAllocatedMemory: {
		...
		valueKind:    ValueInt,
		unit:         "%",
		description:  "memory ceilings of the installed services as a share of the total memory of the host, capped at one hundred",
	...
	MetricHostFailedLogs: {
		...
		valueKind:   ValueInt,
		unit:        "%",
		description: "kernel log messages at error level within the trend window, as a share of a ten message budget",
	...
	MetricHostFailedShares: {
		...
		valueKind:   ValueInt,
		unit:        "",
		description: "shares failing to mount or report, not yet implemented and always zero",
	...
	MetricHostWarnTemperatureOfMax: {
		...
		valueKind:   ValueInt,
		unit:        "%",
		description: "hottest processor temperature as a share of its warning ceiling, zero at forty degrees and full at sixty degrees",
	...
	MetricHostSpinFanSpeedOfMax: {
		...
		valueKind:   ValueInt,
		unit:        "%",
		description: "fastest fan speed as a share of its rated maximum speed",
	...
	MetricHostLifeUsedDrives: {
		...
		valueKind:   ValueInt,
		unit:        "%",
		description: "life used by the most worn drive, not yet implemented and always zero",
	...
	MetricHostUsedSystemSpace: {
		...
		valueKind:   ValueInt,
		unit:        "%",
		description: "system volume space used, not yet implemented and always zero",
	...
	MetricHostUsedShareSpace: {
		...
		valueKind:   ValueInt,
		unit:        "%",
		description: "share volume space used, not yet implemented and always zero",
	...
	MetricServiceUsedMemory: {
		...
		valueKind:   ValueInt,
		unit:        "%",
		description: "memory in use by the service, excluding page cache, as a share of its ceiling",

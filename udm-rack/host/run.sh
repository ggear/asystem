...
# Clients -> udm-rack 192.168.1.1, macbookpro-flo 192.168.1.9, macmini-liz 192.168.1.10, phillips-hue 192.168.1.12, lounge-tv 192.168.1.13, tplplug-* 192.168.1.20+, haiku-* 192.168.1.40+
